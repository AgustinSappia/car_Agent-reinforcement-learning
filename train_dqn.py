...
try:
    for episode in range(CONFIG['episodes']):
        ...
        while not done and step_count < CONFIG['max_steps']:
            # CORREGIDO: Procesar eventos de pygame para evitar bloqueo al minimizar
            for event in pygame.event.get():
                if event.type == pygame.QUIT:
                    raise KeyboardInterrupt("Ventana cerrada por el usuario")
            ...
            # CORREGIDO: Renderizar con manejo de errores para ventana minimizada
            if hasattr(env, 'screen') and env.screen:
                try:
                    ...
                    # Ignorar errores de renderizado (ej: ventana minimizada)
                    pass
